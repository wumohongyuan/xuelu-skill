...
1. **反馈教学错误**：如果你在使用中发现 AI 存在事实错误，请在 [Issues](https://github.com/wumohongyuan/xuelu-skill/issues) 提交对话记录。
2. **优化 Prompt**：如果你觉得指令不够清晰，欢迎 Fork 并提交 Pull Request。
3. **分享案例**：欢迎在 [Discussions](https://github.com/wumohongyuan/xuelu-skill/discussions) 分享你的使用故事。
